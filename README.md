...
```bash
# Clone the repo
git clone https://github.com/chaitanyasiri561/TRAVEL-ITINERARY-OPTIMIZER.git
cd travel-optimizer
...
| Name | Role |
|------|------|
| CHAITANYA SIRI | Algorithm Design & Implementation |
| VIDHYA | Greedy Algorithm (TSP) |
| JEESHITHA | Dynamic Programming (Knapsack) |
| JEEVANA | Dijkstra Algorithm |
| ALPANA | Testing & Documentation |
